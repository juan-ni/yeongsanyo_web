...
const exhibitionItems = [
  ...
  { id: 2, title: '흐르는 시간', category: 'Fashion', size: 'md:col-span-1 md:row-span-1',image: '/images/hahyeonhui_1.png',description: '하현희 작가의 작품으로 탑의 형태에서 영감을 받아 향을 꽂아 사용할 수 있는 디자인입니다. 전통적인 형태에 현대적인 감각을 더해 일상 속에서 예술을 즐길 수 있도록 제작되었습니다.' },
  { id: 3, title: 'Flowing Grain Study', category: 'Archive', size: 'md:col-span-1 md:row-span-2',image: '/images/ha_believe.jpeg' },
  { id: 4, title: '흙속바다', category: 'Process', size: 'md:col-span-1 md:row-span-1',image: '/images/insour.jpeg', description: '박정규 명장이 도자기를 처음 시작했을 때 분청에 그려지는 어문을 보며 흙속의 바다를 느꼈고 오랜시간 도자를 하면서 함께 흙속을 헤엄하던 기억이 만들어낸 작품입니다.'},
