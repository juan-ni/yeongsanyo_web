...
const exhibitionItems = [
  ...
  { id: 7, title: '다도세트', category: 'Ceramics', size: 'md:col-span-1 md:row-span-2',image: '/images/teaware.jpeg', description: 'ㄴㄴㄴ' },
  { id: 8, title: '간절함', category: 'Ceramics', size: 'md:col-span-2 md:row-span-2',image: '/images/ha_time.jpg', description: ' ㄴㄴㄴ' },
  ...
  { id: 10, title: '분청의 결', category: 'Ceramics', size: 'md:col-span-1 md:row-span-1' ,image: '/images/ha_flower4.jpg', description: 'ㅁㅁ' },
  { id: 11, title: 'Pattern Logic', category: 'Ceramics', size: 'md:col-span-1 md:row-span-2',image: '/images/ha_top1.jpeg', description: 'ㅁㅁ' },
  { id: 12, title: '야광명월', category: 'Ceramics', size: 'md:col-span-1 md:row-span-1' ,image: '/images/ha_moonjar.jpg', description: 'ㅁㅁ' },
  { id: 13, title: '숨쉬는 이중차호', category: 'Ceramics', size: 'md:col-span-2 md:row-span-1',image: '/images/tea_carrier.jpeg', description: 'ㅁㅁ' },
  { id: 14, title: '분청철화어문편병', category: 'Ceramics', size: 'md:col-span-1 md:row-span-1' ,image: '/images/ha_and_park.jpg', description: 'ㅁㅁ' },
  { id: 15, title: '미니멀리즘의 극치', category: 'Ceramics', size: 'md:col-span-1 md:row-span-2' ,image: '/images/ha_flower1.png', description: 'ㅁㅁ' },
  { id: 16, title: '전통의 현대적 해석', category: 'Ceramics', size: 'md:col-span-2 md:row-span-2' ,image: '/images/park_2.png', description: 'ㅐㅐ' },
  { id: 17, title: '5층탑', category: 'Ceramics', size: 'md:col-span-1 md:row-span-1' ,image: '/images/ha_flower2.png', description: 'ㅐㅐ' },
  { id: 18, title:'꽃을 위한', category: 'Ceramics', size: 'md:col-span-1 md:row-span-1' ,image: '/images/ha_flower3.jpg', description: 'ㅁㅁ' },
  { id: 19, title: '농차세트', category: 'Ceramics', size: 'md:col-span-2 md:row-span-1' ,image: '/images/park_teaware.png', description: 'ㅁㅁ' },
  { id: 20, title: '분청 달항아리', category: 'Ceramics', size: 'md:col-span-1 md:row-span-1',image: '/images/buncheong_moonjar.jpeg', description: 'ㅁㅁ' },
];
