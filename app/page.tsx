...
const exhibitionItems = [
  ...
  { id: 3, title: 'Flowing Grain Study', category: 'Ceramics', size: 'md:col-span-1 md:row-span-2',image: '/images/ha_believe.jpeg' },
  ...
  { id: 6, title: 'Genderless Silhouette', category: 'Ceramics', size: 'md:col-span-2 md:row-span-1' ,image: '/images/park_1.jpeg'},
  { id: 7, title: '가마의 온도', category: 'Ceramics', size: 'md:col-span-1 md:row-span-2',image: '/images/teaware.jpeg' },
  { id: 8, title: 'Digital Craftmanship', category: 'Ceramics', size: 'md:col-span-2 md:row-span-2',image: '/images/ha_time.jpg' },
  { id: 9, title: '백자의 여백', category: 'Ceramics', size: 'md:col-span-1 md:row-span-1',image: '/images/park_wave.jpeg' },
  { id: 10, title: 'Urban Tech-wear', category: 'Ceramics', size: 'md:col-span-1 md:row-span-1' ,image: '/images/ha_flower4.jpg'},
  { id: 11, title: 'Pattern Logic', category: 'Ceramics', size: 'md:col-span-1 md:row-span-2',image: '/images/ha_top1.jpeg' },
  { id: 12, title: 'Master’s Hand', category: 'Ceramics', size: 'md:col-span-1 md:row-span-1' ,image: '/images/ha_moonjar.jpg'},
  { id: 13, title: 'Fabric Texture #01', category: 'Ceramics', size: 'md:col-span-2 md:row-span-1',image: '/images/tea_carrier.jpeg' },
  { id: 14, title: 'Embedded Soul', category: 'Ceramics', size: 'md:col-span-1 md:row-span-1' ,image: '/images/ha_and_park.jpg'},
  { id: 15, title: '미니멀리즘의 극치', category: 'Ceramics', size: 'md:col-span-1 md:row-span-2' ,image: '/images/ha_flower1.png'},
  { id: 16, title: '전통의 현대적 해석', category: 'Ceramics', size: 'md:col-span-2 md:row-span-2' ,image: '/images/park_2.png'},
  { id: 17, title: 'Glaze Experiment', category: 'Ceramics', size: 'md:col-span-1 md:row-span-1' ,image: '/images/ha_flower2.png'},
  { id: 18, title: 'The Future Art', category: 'Ceramics', size: 'md:col-span-1 md:row-span-1' ,image: '/images/ha_flower3.jpg'},
  { id: 19, title: '밤의 가마터', category: 'Ceramics', size: 'md:col-span-2 md:row-span-1' ,image: '/images/park_teaware.png'},
  { id: 20, title: 'YEONGSANYO Identity', category: 'Ceramics', size: 'md:col-span-1 md:row-span-1',image: '/images/buncheong_moonjar.jpeg' },
];
