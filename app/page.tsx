...
const exhibitionItems = [
  ...
  { id: 5, title: '청유의 깊이', category: 'Ceramics', size: 'md:col-span-1 md:row-span-1',image: '/images/wall_flower1.png', description: '하현희 작가의 작품으로, 전통적인 도자기의 형태에 현대적인 감각을 더해 일상 속에서 예술을 즐길 수 있도록 제작되었습니다.' },
  { id: 6, title: '분청어문편병', category: 'Ceramics', size: 'md:col-span-2 md:row-span-1' ,image: '/images/park_1.jpeg', description: '박정규 명장의 작품으로, 전통적인 도자기의 형태에 현대적인 감각을 더해 일상 속에서 예술을 즐길 수 있도록 제작되었습니다. 기원은 과거와 현재, 그리고 미래를 잇는 다리 역할을 하며, 우리의 삶에 긍정적인 에너지를 불어넣는 작품입니다.'},
  { id: 7, title: '가마의 온도', category: 'Ceramics', size: 'md:col-span-1 md:row-span-2',image: '/images/teaware.jpeg', description: '하현희 작가의 작품으로, 전통적인 도자기의 형태에 현대적인 감각을 더해 일상 속에서 예술을 즐길 수 있도록 제작되었습니다.' },
  { id: 8, title: '다도세트', category: 'Ceramics', size: 'md:col-span-2 md:row-span-2',image: '/images/ha_time.jpg', description: '하현희 작가의 작품으로, 전통적인 도자기의 형태에 현대적인 감각을 더해 일상 속에서 예술을 즐길 수 있도록 제작되었습니다.' },
  ...
  { id: 10, title: 'Urban Tech-wear', category: 'Ceramics', size: 'md:col-span-1 md:row-span-1' ,image: '/images/ha_flower4.jpg', description: '하현희 작가의 작품으로, 전통적인 도자기의 형태에 현대적인 감각을 더해 일상 속에서 예술을 즐길 수 있도록 제작되었습니다.' },
  { id: 11, title: 'Pattern Logic', category: 'Ceramics', size: 'md:col-span-1 md:row-span-2',image: '/images/ha_top1.jpeg', description: '하현희 작가의 작품으로, 전통적인 도자기의 형태에 현대적인 감각을 더해 일상 속에서 예술을 즐길 수 있도록 제작되었습니다.' },
  { id: 12, title: 'Master’s Hand', category: 'Ceramics', size: 'md:col-span-1 md:row-span-1' ,image: '/images/ha_moonjar.jpg', description: '하현희 작가의 작품으로, 전통적인 도자기의 형태에 현대적인 감각을 더해 일상 속에서 예술을 즐길 수 있도록 제작되었습니다.' },
  { id: 13, title: 'Fabric Texture #01', category: 'Ceramics', size: 'md:col-span-2 md:row-span-1',image: '/images/tea_carrier.jpeg', description: '하현희 작가의 작품으로, 전통적인 도자기의 형태에 현대적인 감각을 더해 일상 속에서 예술을 즐길 수 있도록 제작되었습니다.' },
  { id: 14, title: 'Embedded Soul', category: 'Ceramics', size: 'md:col-span-1 md:row-span-1' ,image: '/images/ha_and_park.jpg', description: '하현희 작가의 작품으로, 전통적인 도자기의 형태에 현대적인 감각을 더해 일상 속에서 예술을 즐길 수 있도록 제작되었습니다.' },
  { id: 15, title: '미니멀리즘의 극치', category: 'Ceramics', size: 'md:col-span-1 md:row-span-2' ,image: '/images/ha_flower1.png', description: '하현희 작가의 작품으로, 전통적인 도자기의 형태에 현대적인 감각을 더해 일상 속에서 예술을 즐길 수 있도록 제작되었습니다.' },
  { id: 16, title: '전통의 현대적 해석', category: 'Ceramics', size: 'md:col-span-2 md:row-span-2' ,image: '/images/park_2.png', description: '박정규 명장의 작품으로, 전통적인 도자기의 형태에 현대적인 감각을 더해 일상 속에서 예술을 즐길 수 있도록 제작되었습니다.' },
  { id: 17, title: 'Glaze Experiment', category: 'Ceramics', size: 'md:col-span-1 md:row-span-1' ,image: '/images/ha_flower2.png', description: '하현희 작가의 작품으로, 전통적인 도자기의 형태에 현대적인 감각을 더해 일상 속에서 예술을 즐길 수 있도록 제작되었습니다.' },
  { id: 18, title:'꽃을 위한', category: 'Ceramics', size: 'md:col-span-1 md:row-span-1' ,image: '/images/ha_flower3.jpg', description: '하현희 작가의 작품으로, 전통적인 도자기의 형태에 현대적인 감각을 더해 일상 속에서 예술을 즐길 수 있도록 제작되었습니다.' },
  { id: 19, title: '농차세트', category: 'Ceramics', size: 'md:col-span-2 md:row-span-1' ,image: '/images/park_teaware.png', description: '박정규 명장의 작품으로, 전통적인 도자기의 형태에 현대적인 감각을 더해 일상 속에서 예술을 즐길 수 있도록 제작되었습니다.' },
  { id: 20, title: '분청 달항아리', category: 'Ceramics', size: 'md:col-span-1 md:row-span-1',image: '/images/buncheong_moonjar.jpeg', description: '박정규 명장의 작품으로, 전통적인 도자기의 형태에 현대적인 감각을 더해 일상 속에서 예술을 즐길 수 있도록 제작되었습니다.' },
];
