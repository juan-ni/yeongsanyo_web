...
const exhibitionItems = [
  ...
  { id: 7, title: '다도세트', category: 'Ceramics', size: 'md:col-span-1 md:row-span-2',image: '/images/teaware.jpeg', description: '하현희 작가의 작품으로, 전통적인 도자기의 형태에 현대적인 감각을 더해 일상 속에서 예술을 즐길 수 있도록 제작되었습니다.' },
  { id: 8, title: '간절함', category: 'Ceramics', size: 'md:col-span-2 md:row-span-2',image: '/images/ha_time.jpg', description: '하현희 작가의 작품으로, 전통적인 도자기의 형태에 현대적인 감각을 더해 일상 속에서 예술을 즐길 수 있도록 제작되었습니다.' },
  ...
  { id: 10, title: '분청의 결', category: 'Ceramics', size: 'md:col-span-1 md:row-span-1' ,image: '/images/ha_flower4.jpg', description: '하현희 작가의 작품으로, 전통적인 도자기의 형태에 현대적인 감각을 더해 일상 속에서 예술을 즐길 수 있도록 제작되었습니다.' },
  ...
  { id: 12, title: '야광명월', category: 'Ceramics', size: 'md:col-span-1 md:row-span-1' ,image: '/images/ha_moonjar.jpg', description: '하현희 작가의 작품으로, 전통적인 도자기의 형태에 현대적인 감각을 더해 일상 속에서 예술을 즐길 수 있도록 제작되었습니다.' },
  { id: 13, title: '숨쉬는 이중차호', category: 'Ceramics', size: 'md:col-span-2 md:row-span-1',image: '/images/tea_carrier.jpeg', description: '하현희 작가의 작품으로, 전통적인 도자기의 형태에 현대적인 감각을 더해 일상 속에서 예술을 즐길 수 있도록 제작되었습니다.' },
  { id: 14, title: '분청철화어문편병', category: 'Ceramics', size: 'md:col-span-1 md:row-span-1' ,image: '/images/ha_and_park.jpg', description: '하현희 작가의 작품으로, 전통적인 도자기의 형태에 현대적인 감각을 더해 일상 속에서 예술을 즐길 수 있도록 제작되었습니다.' },
  ...
  { id: 17, title: '5층탑', category: 'Ceramics', size: 'md:col-span-1 md:row-span-1' ,image: '/images/ha_flower2.png', description: '하현희 작가의 작품으로, 전통적인 도자기의 형태에 현대적인 감각을 더해 일상 속에서 예술을 즐길 수 있도록 제작되었습니다.' },
