...
export default function HaMaster() {
  ...
  BACK TO MUSEUM
      ...
      <div className="max-w-4xl mx-auto">
        <motion.span initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="text-xs tracking-[0.5em] text-zinc-500 uppercase">Art Director</motion.span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 flex-row-reverse">
          <div className="aspect-[3/4] bg-zinc-900 border border-white/5 relative overflow-hidden">
             {/* <Image src="/master-ha.jpg" alt="Master Ha" fill className="object-cover opacity-70" /> */}
             <div className="absolute inset-0 flex items-center justify-center text-[10px] tracking-widest text-zinc-700">ARTIST PORTRAIT</div>
          </div>
          ...
          <div className="space-y-8 text-zinc-400 font-light leading-relaxed">
            ...
            <p>그녀의 시선은 도자기에 머물지 않고, 그것이 놓이는 공간의 공기까지 디자인합니다.</p>
          </div>
        </div>
      </div>
